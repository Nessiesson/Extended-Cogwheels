...
public class CogWheelKineticTileEntityInstance extends BracketedKineticTileInstance {
    public CogWheelKineticTileEntityInstance(MaterialManager modelManager, KineticTileEntity tile) {
