...
public class CustomCogWheelTileEntitiyRenderer extends BracketedKineticTileRenderer {
    public CustomCogWheelTileEntitiyRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    @Override
